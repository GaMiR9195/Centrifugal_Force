...
public class AeroCamSync {
    ...
    public AeroCamSync(IEventBus modEventBus) {
        ...
        // Серверная половина тестового потребителя API — только дев-ран. Гейт стоит здесь, а не
        // внутри класса: так в собранном моде он не грузится и команда /acsapi не появляется.
