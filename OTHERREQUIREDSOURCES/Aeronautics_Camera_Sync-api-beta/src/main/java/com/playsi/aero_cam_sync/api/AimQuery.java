 ...
 *
 * <p>Valid only for the duration of the {@code decide} call — do not keep it.</p>
 */
public interface AimQuery {
     ...
     * {@code clip} and we are asking about it anyway.
     */
     ...
     * returns {@link AimPolicy.Decision#SHIFT}.</p>
     */
    boolean startsAtEye();
}
